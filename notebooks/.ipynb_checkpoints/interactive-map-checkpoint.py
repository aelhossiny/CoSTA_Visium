...
y_pred_acinar = np.load("../results/training_results_arrays/y_pred_acinar.npy")#[0:5] # uncomment slicing to speed up for testing
dataset = np.load("../results/training_results_arrays/acinar_cell_carcinoma_fil.npy")#[0:5]
au_tar_acinar = np.load("../results/training_results_arrays/au_tar_acinar.npy")#[0:5]
gene_names = np.load("../results/training_results_arrays/gene_list.npy")
